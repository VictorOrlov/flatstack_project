...
const heroes_for_ThisHeroPage = {
  starlord:{
    ...
    short_story: 
      <div>
        <p><strong>Питер Квилл — космический авантюрист, который живет 
          бесконечными приключениями. Лидер команды «Стражи Галактики».</strong></p>
        <p>Питер Квилл родом с Земли, был воспитан матерью, которая 
          ...
          стал бандитом, взяв себе псевдоним Звёздный Лорд.</p>
        <p>Во время очередной авантюры Звёздный Лорд украл загадочную 
          ...
          «Стражи Галактики».</p>
        <p>У Звёздного Лорда есть разные приспособления для работы в 
          ...
          он дал клятву не забирать чужую жизнь, пока есть другой выход.</p>
        <p>Харизма и уникальное чувство юмора Питера могут как спасти 
  ...
  raketa:{
    ...
    short_story: 
      <div>
        <p><strong>За плечами кибернетически усовершенствованного 
          ...
          не любит, когда над ним смеются.</strong></p>
        <p>Объект 89P13, который называет себя Ракетой, — результат 
          ...
          и 15 поджогов.</p>
        <p>Во время своих путешествий Ракета встретил Грута, 
          ...
          ему, сформировав команду под названием «Стражи Галактики».</p>
        <p>Ракета обладает всеми особенностями обычного енота, 
          такими как острый нюх и зрение. В ходе эксперимента Ракета 
          получил модифицированный скелет, который позволяет ему 
          передвигаться и на двух, и на четырёх лапах.</p>
        <p>Ракета обладает острым умом, находчивостью и блестящими 
          ...
          бомбы из ничего.</p>
        <p>У Ракеты сложный характер, он вспыльчив, не всегда справляется 
          с гневом и совершает необдуманные поступки, которые часто 
          создают неприятности для всей команды.</p>
      </div>,
    img: raketa
  },
  grut:{
    ...
    short_story: 
      <div>
        <p><strong>Похожий на дерево пришелец Грут обладает невероятной 
          физической силой, добрым сердцем и одной-единственной фразой в 
          лексиконе.</strong></p>
        <p>Грут — древоподобный пришелец с планеты Икс, криминальное 
          прошлое которого насчитывает 3 факта причинения тяжких телесных 
          повреждений, 15 случаев побега из-под ареста и 3 факта 
          наёмнической деятельности.</p>
        <p>Грут долгое время был напарником Ракеты в охоте за головами, 
          ...
          удалось сбежать из тюрьмы.</p>
        <p>Сделка со Сферой провалилась, и артефактом завладел опасный 
          ...
          товарищей.</p>
        <p>Благодаря способности к регенерации Грут может менять 
          ...
          только на определённых планетах с растительными формами жизни.</p>
        <p>В лексиконе Грута есть только фраза «Я есть Грут», под 
  ...
  gamora:{
    ...
    short_story: 
      <div>
        <p>Последняя выжившая представительница расы Зен-Хобери, 
          ...
          «Стражи Галактики».</p>
        <p>Когда Звёздный Лорд украл один из Камней Бесконечности, 
          ...
          все четверо были арестованы Корпусом Нова.</p>
        <p>Многие заключённые в тюрьме угрожали ей расправой за грехи 
          ...
          на хранение Корпусу Нова.</p>
        <p>Гамора — настоящий эксперт в контактном бою, прекрасная 
  ...
  draks:{
    ...
    short_story: 
      <div>
        <p>Когда Ронан по приказу безумного титана Таноса хладнокровно 
          ...
          и Дракс планировал, что она выведет его на Ронана.</p>
        <p>Когда Дракс, наконец, встретился с Ронаном один на один, он 
          ...
          защитить от Ронана вселенную.</p>
        <p>Дракс — первоклассный боец, обладающий огромной силой и 
          ...
          в любой схватке.</p>
        <p>Дракс неоднократно показывал свою неспособность понимать метафоры 
          и символизм в речи. Несмотря на это, он внимательно относится к 
          своим друзьям, помогая им справляться с трудностями.</p>
      </div>,
    img: draks
  },
  spidy:{
    ...
    short_story: 
      <div>
        <p><strong>Когда обычного подростка Питера Паркера укусил 
          радиоактивный паук, его жизнь полностью изменилась. Теперь 
          он борется с преступностью, скрываясь под маской 
          Человека-Паука.</strong></p>
        <p>Ещё ребёнком Питер Паркер лишился родителей, а тётя Мэй и 
          ...
          суперсилой и уникальными способностями.</p>
        <p>Желая заработать на своих новых силах, Питер сделал себе 
          ...
          ответственность»</p>
        <p>У Человека-Паука множество опасных врагов, от которых он много 
          ...
          Человека-Паука.</p>
        <p>Человек-Паук обладает множеством уникальных способностей и является 
          ...
          избегать ранений и предугадывать действия противника.</p>
        <p>Ещё до укуса паука Питер Паркер был одним из самых умных людей на 
          ...
          веб-шутерами с сверхпрочной искусственной паутиной.</p>
      </div>,
    img: spidy
  },
  ironman:{
    ...
    short_story: 
      <div>
        <p><strong>Эксцентричный гений, миллионер, дамский угодник и 
          филантроп Тони Старк также является супергероем в броне, 
          известным как Железный Человек.</strong></p>
        <p>Тони Старк – сын богатого промышленника и изобретателя 
          ...
          шрапнелью миллиардер попал в плен к оружейному барону Вонг-Чу</p>
        <p>Глава террористов обещал оставить Старка в живых, если тот 
          ...
          профессор Хо Инсен, чьи работы вдохновляли Старка в колледже.</p>
        <p>Вместе они создали боевой костюм с генератором магнитного поля, 
          ...
          от которого полностью зависела его жизнь.</p>
        <p>По этическим соображениям Тони прекратил заниматься производством 
          ...
          личности и признаться, что он и есть Железный Человек.</p>
        <p>Тони Старк прекрасно знает себе цену: он одновременно является и 
          ...
          это ради достижения своей главной цели – спасения жизни людей.</p>
        <p>Созданный Тони Старком высокотехнологичный костюм Железного 
          ...
          связаться со спутниками или штабом Мстителей.</p>
        <p>Тони Старк разработал множество моделей своего костюма для разных 
          целей. Так, например, один из них полностью предназначен для 
          стелс-операций, а другой позволяет передвигаться в открытом космосе.</p>
      </div>,
    img: ironman
  },
  hulk:{
    ...
    short_story: 
      <div>
        <p>Спасая жизнь подростку, доктор Брюс Беннер оказался в эпицентре 
          ...
          он теряет контроль над собой и превращается в зелёного монстра Халка.</p>
        <p>Выдающиеся интеллектуальные способности Брюса начали проявляться в 
          ...
          в зоне поражения и получил огромную дозу гамма-радиации.</p>
        <p>По неизвестной причине, скрытой в генах Бэннера, взрыв не 
          ...
          крови Брюса, вызванного гневом.</p>
        <p>Халк обладает безграничной мощью и выносливостью, которые 
          ...
          секунды. Это делает Халка одним из самых сильных существ на планете.</p>
        <p>Брюс Бэннер не способен полностью контролировать Халка, поэтому, 
          ...
          в команде Мстителей.</p>
        <p>В отличие от своего альтер-эго, доктор Брюс Бэннер — гениальный учёный, 
  ...
  thor:{
    ...
    short_story: 
      <div>
        <p><strong>Могущественный бог грома Тор, достойный носить величайшее 
          оружие во вселенной – волшебный молот Мьёльнир — никогда не 
          перестаёт сражаться за правое дело и защищать любимую Землю.</strong></p>
        <p>Тор — дитя союза Одина, владыки Асгарда, и Геи, богини 
          ...
          началась их многовековая вражда.</p>
        <p>Когда Тору исполнилось восемь, Один сделал для него Мьёльнир — 
          ...
          чести и был провозглашён великим воином Асгарда.</p>
        <p>Почти безграничные возможности не могли не повлиять на характер 
          ...
          божественной силы.</p>
        <p>Когда Тор осознал свои ошибки и в очередной раз доказал своё право 
          ...
          участников команды Мстителей.</p>
        <p>Сын двух могущественных богов, Тор обладает невероятной силой и 
          ...
          Мьёльнир может только тот, кто достоин править Асгардом.</p>
      </div>,
    img: tor
  },
  capitan:{
    ...
    short_story: 
      <div>
        <p><strong>Герой вне времени Стив Роджерс борется за свободу 
          в качестве непоколебимого Капитана Америка.</strong></p>
        <p>Во время Второй мировой войны юный Стивен Роджерс согласился 
          ...
          продолжить битву за справедливость.</p>
        <p>Стивен Роджерс с детства отличался хрупким телосложением и 
          ...
          которая доводит физические способности человека до пика. </p>
        <p>Профессор Авраам Эрскин, разработавший сыворотку, увидел в 
          ...
          сыворотки.</p>
        <p>Стив Роджерс стал агентом контрразведки и символом борьбы против 
          нацистской Германии. Он получил красно-бело-синий костюм, 
          созданный по его собственным эскизам, и кодовое имя – Капитан 
          Америка.</p>
        <p>Стив и его верные союзники спасли множество жизней, обезвредили 
          ...
          объявлен погибшим.</p>
        <p>Тело Стива Роджерса было обнаружено во льдах спустя много лет 
          ...
          Мстителей.</p>
        <p>Сыворотка многократно усилила его физические характеристики и 
  ...
  vdova:{
    ...
    short_story: 
      <div>
        <p><strong>Наташа Романофф, известная также как Черная Вдова, — 
          ...
          агентов службы Щ.И.Т. и присоединилась к команде Мстителей.</strong></p>
        <p>Данных о прошлом Наташи Романовой не так много. Известно, 
          ...
          внедрению во вражеские организации по всему миру.</p>
        <p>Романова обучалась у Зимнего Солдата и подверглась ряду 
          ...
          лётчиком-испытателем Алексеем Шостаковым.</p>
        <p>Чёрная Вдова — одна из основателей команды Мстители. Желая 
          ...
          Капитаном Америка и Железным Человеком.</p>
      </div>,
    img: redhead
  },
  ant:{
    ...
    short_story: 
      <div>
        <p><strong>Благодаря костюму, позволяющему ему менять размеры 
          собственного тела  и при этом становиться сильнее, Скотт 
          Лэнг стал супергероем, известным как Человек-Муравей.</strong></p>
        <p>Подающий надежды инженер и специалист в области электроники, 
          ...
          в размерах.</p>
        <p>Хэнк Пим обучил Скотта использовать костюм, чтобы обезвредить 
          ...
          команды «Мстители». </p>
        <p>Костюм Человека-Муравья позволяет Скотту уменьшаться в размерах, 
          ...
          впоследствии стала его напарницей, известной как Оса.</p>
      </div>,
    img: ant
  },
  socol:{
    ...
    short_story: 
      <div>
        <p><strong>Благодаря своей исключительной реакции, координации 
          и меткости Соколиный Глаз — лучший стрелок и лучник, известный 
          человечеству.</strong></p>
        <p>Бартон с четырнадцати лет путешествовал с бродячим цирком, 
          ...
          на ярмарках и карнавалах под псевдонимом Соколиный Глаз.</p>
        <p>Подвиги Железного Человека вдохновили Бартона надеть костюм и 
          ...
          настроила Бартона против Тони Старка.</p>
        <p>Бартон вскоре пожалел об этом и, чтобы загладить вину, выдвинул 
          ...
          многих лет, делая лишь короткие перерывы.</p>
        <p>Соколиный Глаз — непревзойденный мастер стрельбы из лука, чья 
          ...
          воздушной гимнастики и рукопашного боя.</p>
        <p>Таких впечатляющих результатов Соколиный Глаз добился ежедневными 
          ...
          Хэнка Пима и помогал Мстителям как Голиаф.</p>
      </div>,
    img: socol
  },
  strange:{
    ...
    short_story: 
      <div>
        <p><strong>Когда страшная автокатастрофа поставила крест 
          на карьере гениального нейрохирурга Стивена Стрэнджа, он 
          обратился к мистическим практикам, которые навсегда 
          изменили его жизнь.</strong></p>
        <p>Попав в страшную автомобильную аварию, успешный нейрохирург 
          ...
          за пределами нашего измерения.</p>
        <p>Благодаря Древней, Стивен Стрэндж становится могущественным 
          ...
          умеет обращаться с холодным оружием.</p>
        <p>После гибели своего учителя Доктор Стрэндж становится Верховным 
          Магом, главная задача которого – защита человечества.</p>
      </div>,
    img: strange
  }
};
